...
const principles = [
	{
		description: "We listen for context, intent, and cultural nuance—not only the words being spoken.",
		...
		<Main>
			...
			>
				<div className="mx-auto w-full max-w-350">
					...
					<h1
						className="mt-7 max-w-260 text-[clamp(3.25rem,8vw,7rem)] leading-[0.95] font-bold
					...
					<p className="mt-8 max-w-190 text-lg/relaxed text-pretty text-white/75 md:text-xl">
						We help people, organizations, and communities communicate across languages with clarity,
						respect, and attention to context.
					</p>
				</div>
			</section>
			...
			<section className="bg-white px-5 py-24 md:px-10 md:py-32 lg:px-[8%]">
				<div className="mx-auto grid w-full max-w-350 gap-14 lg:grid-cols-[0.7fr_1.3fr]">
					<div>
						...
						<h2
							className="mt-4 text-4xl/tight font-bold tracking-tight text-balance
					...
					<div className="space-y-6 text-lg/relaxed text-twin-secondary-main">
						<p>
							Every setting has its own language, expectations, and stakes. A medical visit differs
							from a school conference; a business meeting differs from a legal proceeding. We begin
			...
			<section className="bg-twin-light-1 px-5 py-24 md:px-10 md:py-32 lg:px-[8%]">
				<div className="mx-auto w-full max-w-350">
					...
					<div
						className="mt-10 divide-y divide-twin-primary-main/14 border-y
					...
					>
						{principles.map((principle, index) => (
							...
							>
								...
								<p className="text-lg/relaxed text-twin-secondary-main">{principle.description}</p>
							</article>
						))}
					</div>
				</div>
			...
			<section className="bg-twin-primary-main px-5 py-24 text-white md:px-10 md:py-28 lg:px-[8%]">
				<div
					className="mx-auto flex w-full max-w-350 flex-col justify-between gap-10 lg:flex-row
						lg:items-end"
				>
					<div>
						...
						<h2
							className="mt-4 max-w-220 text-4xl/tight font-bold tracking-tight text-balance
								md:text-6xl"
						>
					...
					<Link
						...
						className="inline-flex min-h-14 items-center justify-center gap-3 rounded-full
							...
							transition-[background-color,transform] duration-160 ease-out hover:bg-white
