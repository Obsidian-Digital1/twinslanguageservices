...
export function TestimonialsSection({
	...
	return (
		<section className={cnMerge("flex w-full justify-center bg-twin-primary-main px-6 py-28", className)}>
			<div className="flex w-full max-w-275 flex-col items-center gap-14 sm:gap-16">
				<div className="flex flex-col items-center gap-5 px-4 text-center">
					<p className="mb-5 text-lg font-black tracking-[0.28em] text-twin-accent-main uppercase">
						Reviews
					</p>
					<h2
				...
				<div className="relative flex w-full flex-col items-center justify-center overflow-hidden">
					...
					<div
						className="pointer-events-none absolute inset-y-0 left-0 hidden w-1/4 bg-linear-to-r
							from-twin-primary-main sm:block"
					/>
					<div
	...
	return (
		<Element
			...
			className={cnMerge(
				...
				"hover:border-twin-accent-main/38 hover:bg-twin-accent-main/5",
		...
		>
			<div className="flex items-center gap-4">
				...
				<div className="flex flex-col items-start gap-1">
					...
					<p className="text-sm font-medium text-twin-accent-lighter/80">{author.handle}</p>
				</div>
			</div>
